...
pygame.init()
pygame.display.set_caption("sneki")
pygame.font.init()
random.seed()
...
start_page = pygame.image.load("start_page.jpeg")
start_page = pygame.transform.scale(start_page, (SCREEN_WIDTH, SCREEN_HEIGHT))
...
def play_text():
    play_text = play.render("PLAY", True, (0, 0, 0))
    screen.blit(play_text, (150, 410))
...
class Snake:
    ...
    def draw(self, screen):
        pygame.draw.rect(screen, pygame.color.Color("maroon"),
...
def starting_page():
    while True:
        ...
        button1 = pygame.Rect(100, 400, 200, 50)
        play_text()
